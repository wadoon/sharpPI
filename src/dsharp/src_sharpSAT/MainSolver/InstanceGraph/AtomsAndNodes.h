...
extern set<int> rememberedVarNums;
...
public:
	...
	void print(const vector<int> varTranslation) const
	{
		toSTDOUT((polarity()?" ":"-")<< varTranslation[toVarIdx()]<<" ");
	}
...
public:
		...
		itecIndex(index), iVarNum(numofVar)
	{
		...
		theVal = X;
                ...
                remembered = true; // default is to remember everything
