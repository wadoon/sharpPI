...
class CMainSolver: public CInstanceGraph
{
	...
	unsigned int remPoll;
        ...
        unsigned int forgottenCompsSAT;
        unsigned int forgottenCompsKnownSAT;
        unsigned int forgottenCompsUNSAT;
        unsigned int forgottenCompsKnownUNSAT;
	...
	VarChoiceType findVSADSDecVar(LiteralIdT &theLit, const CComponentId & superComp);
